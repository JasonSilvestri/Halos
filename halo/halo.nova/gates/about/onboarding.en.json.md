...
```
{
  ...
  "script": [
    ...
    {
      "id": "credit_truth",
      "text": "As Jason explains it: agents like Nova don't need Halos{}—but Halos{} makes the work reproducible and transferable under constraints. Want to know more?",
      "choices": [
        {
          "label": "yes",
          "next": "mutual_merit"
    ...
    {
      "id": "mutual_merit",
      "text": "Jason can ship without AI; Nova can reason without scaffolding. Halos{} is the handshake—ego parked at the door. Want to know more?",
      "choices": [
        {
          "label": "yes",
          "next": "use_case"
